...
//    }
//
//    private fun ItemStack.renderOverlayText(stack: OmniMatrixStack, x: Float, y: Float) {
...
//        if (text != null) {
//            GL.pushMatrix()
//            val width = OmniGameRendering.getTextWidth(text)
//            val factor = (17f / width).coerceAtMost(1f)
//            GL.scale(factor, factor, 1f)
//            OmniGameRendering.drawText(stack, text, (x + 17f) / factor - OmniGameRendering.getTextWidth(text), (y + 9f) / factor, 16777215, shadow)
//            GL.popMatrix()
//        }
//
...
//        if (name != null) {
//            GL.pushMatrix()
//            val width = OmniGameRendering.getTextWidth(name)
//            val factor = (17f / width).coerceAtMost(1f)
//            GL.scale(factor, factor, 1f)
//            val offset = if (text != null) 18f else 16f
//            OmniGameRendering.drawText(stack, name, x / factor, (y + offset) / factor, textColor.argb, shadow)
//            GL.popMatrix()
//        }
//
//        GL.enableAlpha()
